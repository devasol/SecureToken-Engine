...
function App() {
  ...
  const JsonBlock = ({ title, data, color, keyColor }) => (
    <div className="space-y-1.5">
      ...
      <div className="bg-black/60 border border-white/10 rounded-xl p-4 font-mono text-[10px] leading-relaxed overflow-x-auto shadow-inner">
      ...
      <footer className="relative z-10 mt-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-[10px] font-black uppercase tracking-[0.4em] text-white/20">
            Designed & Engineered by <span className="text-cyan-500/60">Dawit Solomon</span>
          </p>
        </div>
      </footer>
